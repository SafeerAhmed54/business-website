        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href={`tel:${businessInfo.phone}`} className="text-lg hover:underline">
                    {businessInfo.phone}
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href={`mailto:${businessInfo.email}`} className="text-lg hover:underline">
                    {businessInfo.email}
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg">{businessInfo.address}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg">{businessInfo.hours}</p>
                </div>
              </div>
            </div>

            <div className="mt-8 p-6 bg-white/10 rounded-lg backdrop-blur-sm">
              <h4 className="text-lg font-semibold mb-3">Quick Response Times</h4>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8">
            ...
            <form className="space-y-6">
              ...
              <Button 
                type="submit"
                className="w-full bg-white text-[#2EB62C] hover:bg-gray-100 font-semibold py-4 text-lg"
              >
                Send Message
              </Button>
            </form>
