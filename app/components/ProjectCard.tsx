...
export default function ProjectCard({ project, onImageClick }: ProjectCardProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300 group">
      {/* Project Image */}
      <div className="relative h-48 sm:h-56 lg:h-64 bg-gray-200 overflow-hidden cursor-pointer" onClick={handleImageClick}>
        <OptimizedImage
        ...
        {project.images.length > 1 && (
          <div className="absolute top-2 right-2 sm:top-3 sm:right-3 bg-black bg-opacity-70 text-white px-2 py-1 rounded-md text-xs sm:text-sm">
        ...
        {/* Featured Badge */}
        {project.featured && (
          <div className="absolute top-2 left-2 sm:top-3 sm:left-3 bg-yellow-500 text-white px-2 py-1 rounded-md text-xs sm:text-sm font-medium">
            Featured
          </div>
        )}
      </div>
