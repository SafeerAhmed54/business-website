...
export default function ServicesPage() {
  ...
  return (
    <div className="min-h-screen relative page-transition scroll-smooth">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-indigo-600 mb-1 sm:mb-2">{services.length}</div>
              <div className="text-gray-600 text-sm sm:text-base">Services Offered</div>
            </div>
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-indigo-600 mb-1 sm:mb-2">15+</div>
            ...
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-indigo-600 mb-1 sm:mb-2">24/7</div>
            ...
            {signboardServices.map((service) => (
              ...
              >
                <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center text-white flex-shrink-0">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <span className="text-xs sm:text-sm text-blue-600 font-medium">Signboard Service</span>
                  </div>
                </div>
                ...
                <button className="w-full bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold py-3 px-4 sm:px-6 rounded-xl transition-all duration-300 hover:scale-105 min-h-[48px] touch-manipulation text-sm sm:text-base">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {contractingServices.map((service) => (
              <div
                key={service.id}
                className="bg-gray-50 rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2"
              >
                <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl flex items-center justify-center text-white flex-shrink-0">
                    {serviceIcons[service.id as keyof typeof serviceIcons] || (
                      <svg className="w-6 h-6 sm:w-8 sm:h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                      </svg>
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="text-lg sm:text-xl font-bold text-gray-900 leading-tight">{service.title}</h3>
                    <span className="text-xs sm:text-sm text-orange-600 font-medium">Construction Service</span>
                  </div>
                </div>
                ...
                <button className="w-full bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-semibold py-3 px-4 sm:px-6 rounded-xl transition-all duration-300 hover:scale-105 min-h-[48px] touch-manipulation text-sm sm:text-base">
                  Get Quote for {service.title}
                </button>
              </div>
            ))}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {[
              ...
              <div key={index} className="text-center">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-indigo-600 to-blue-600 rounded-full flex items-center justify-center text-white text-lg sm:text-2xl font-bold mx-auto mb-4 sm:mb-6">
                  {process.step}
                </div>
                <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4">{process.title}</h3>
                <p className="text-gray-600 text-sm sm:text-base leading-relaxed">{process.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* CTA Section */}
      <section className="py-16 sm:py-20 bg-gradient-to-r from-indigo-600 to-blue-600">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 sm:mb-6 leading-tight">
            Ready to Start Your Project?
          </h2>
          <p className="text-lg sm:text-xl text-indigo-100 mb-8 sm:mb-10 max-w-3xl mx-auto leading-relaxed">
            Contact us today for a free consultation and quote. Let&apos;s bring your vision to life!
          </p>
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center">
            <a
              href="tel:+923315666788"
              className="bg-white text-indigo-600 hover:bg-gray-100 font-semibold px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg rounded-2xl transition-all duration-300 hover:scale-105 inline-flex items-center justify-center gap-3 min-h-[48px] touch-manipulation"
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
              <span className="hidden sm:inline">Call Now: {businessInfo.phone}</span>
              <span className="sm:hidden">Call Now</span>
            </a>
            <a
              href="mailto:info@signboardcontractor.com"
              className="border-2 border-white text-white hover:bg-white hover:text-indigo-600 font-semibold px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg rounded-2xl transition-all duration-300 inline-flex items-center justify-center gap-3 min-h-[48px] touch-manipulation"
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
